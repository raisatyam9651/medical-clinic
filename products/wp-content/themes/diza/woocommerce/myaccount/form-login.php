	    	...
	    	<div role="tabpanel" class="tab-pane active" id="login">
				...
				<form id="login" class="woocommerce-form woocommerce-form-login login" method="post">
					...
					<p class="form-row last">
						...
						<button type="submit" class="woocommerce-Button button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="login" value="<?php esc_attr_e( 'Login', 'diza' ); ?>"><?php esc_html_e( 'Login', 'diza' ); ?></button>
					</p>
				...
				<form id="register" method="post" class="woocommerce-form woocommerce-form-register register">
					...
					<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
	      			...
	      			<?php else : ?>
	      				...
	      				<p><?php esc_html_e( 'A link to set a new password will be sent to your email address.', 'diza' ); ?></p>
					...
					<p class="woocommerce-form-row form-row last">
						...
						<button type="submit" class="woocommerce-Button button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="register" value="<?php esc_attr_e( 'Register', 'diza' ); ?>"><?php esc_html_e( 'Register', 'diza' ); ?></button>
					</p>
