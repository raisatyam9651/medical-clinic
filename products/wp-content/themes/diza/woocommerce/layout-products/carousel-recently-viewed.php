...
?>
<div class="owl-carousel products rows-<?php echo esc_attr( $rows_count ); ?> <?php echo esc_attr( $class_item ); ?> <?php diza_slick_carousel_product_block_image_class(); ?>" <?php echo $responsive_carousel; ?>  <?php echo $data_carousel; ?> >
