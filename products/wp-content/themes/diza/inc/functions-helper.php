...
if ( !function_exists('diza_tbay_get_header_layout') ) {
	function diza_tbay_get_header_layout() {
		if ( is_page() ) {
			...
			return diza_tbay_woo_get_header_layout( wc_get_page_id( 'shop' ) );
		} else if( class_exists( 'WooCommerce' ) && is_cart() ) {
			return diza_tbay_woo_get_header_layout( wc_get_page_id( 'cart' ) );
		} else if( class_exists( 'WooCommerce' ) && is_checkout() ) {
			return diza_tbay_woo_get_header_layout( wc_get_page_id( 'checkout' ) );
		}
		return diza_tbay_get_config('header_type', 'header_default');
	}
...
if ( !function_exists('diza_tbay_woo_get_header_layout') ) {
	function diza_tbay_woo_get_header_layout( $page_id ) {
...
if ( !function_exists('diza_tbay_get_footer_layout') ) {
	function diza_tbay_get_footer_layout() {
		if ( is_page() ) {
			...
			return diza_tbay_woo_get_footer_layout( wc_get_page_id( 'shop' ) );
		} else if( class_exists( 'WooCommerce' ) && is_cart() ) {
			return diza_tbay_woo_get_footer_layout( wc_get_page_id( 'cart' ) );
		} else if( class_exists( 'WooCommerce' ) && is_checkout() ) {
			return diza_tbay_woo_get_footer_layout( wc_get_page_id( 'checkout' ) );
		}
...
if ( !function_exists('diza_tbay_woo_get_footer_layout') ) {
	function diza_tbay_woo_get_footer_layout( $page_id ) {
...
if ( ! function_exists( 'diza_elementor_is_edit_mode' ) ) {
	function diza_elementor_is_edit_mode() {
		return Elementor\Plugin::$instance->editor->is_edit_mode();
	}
}

if ( ! function_exists( 'diza_elementor_is_preview_page' ) ) {
	function diza_elementor_is_preview_page() {
		return isset( $_GET['preview_id'] );
	}
} 

if ( ! function_exists( 'diza_elementor_is_preview_mode' ) ) {
	function diza_elementor_is_preview_mode() {
