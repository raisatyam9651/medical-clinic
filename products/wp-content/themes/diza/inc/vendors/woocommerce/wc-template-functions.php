...
if ( ! function_exists( 'diza_woocommerce_sub_categories' ) ) {
    ...
    function diza_woocommerce_sub_categories( $echo = true ) {
        ...
        $loop_start = apply_filters( 'diza_get_woocommerce_sub_categories', ob_get_clean() );
...
if ( ! function_exists( 'diza_is_variable_product_out_of_stock' ) ) {
    function diza_is_variable_product_out_of_stock( $product ) {
...
if ( ! function_exists( 'diza_woocommerce_single_title' ) ) {
    function diza_woocommerce_single_title() {
        the_title( '<h2 class="product_title entry-title">', '</h2>' );
    }
}

/*Fix page search when product_cat emty WOOF  v3.3.4.3*/
if (! function_exists('diza_woo_fix_form_search_cate_empty_woof_new_version')) {
    add_action( 'admin_init', 'diza_woo_fix_form_search_cate_empty_woof_new_version', 10 );
    function diza_woo_fix_form_search_cate_empty_woof_new_version()
    {
