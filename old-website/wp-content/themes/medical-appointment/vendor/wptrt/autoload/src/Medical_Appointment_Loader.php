...
class Medical_Appointment_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function medical_appointment_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function medical_appointment_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function medical_appointment_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function medical_appointment_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->medical_appointment_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function medical_appointment_load( $class ) {
